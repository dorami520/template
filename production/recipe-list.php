          ...
          <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
            <div class="menu_section">
              ...
              <ul class="nav side-menu">
                ...
                <li><a href=""><i class="fa fa-table"></i>商品管理 <span class="fa fa-chevron-down"></span></a>
                </li>
              ...
              <div class="x_panel">
                <div class="x_title">
                  ...
                  <ul class="nav navbar-right panel_toolbox">
                    ...
                    <a href="add-recipe.php" role="button" class="btn btn-secondary"><i
                              ...
                              <tr>
                                ...
                                <td class="">
                                  <div class="ratio ratio-1x1">
                                    <img class="object-fit-cover" src="rimages/<?= $recipe["Image_URL"] ?>"
                                      alt="<?= $recipe["Title_R_name"] ?>">
                                  </div>
                                </td>
                                <td>
                                  <?= $recipe["Content"] ?>
